    ...
    <div class="container">
        ...
        <ul class="nav navbar-nav">
            ...
            <sec:authorize ifAnyGranted="ROLE_USER">
                <li <c:if test="${menu == 'product/add.htm'}">class="active"</c:if>><a href="product/add">Dodaj
                    produkt</a></li>
            </sec:authorize>
        ...
        <div class="navbar-collapse collapse">
            ...
            <sec:authorize access="isAnonymous()">
                ...
                <form class="navbar-form navbar-right" role="form" action='/diabetyk-web/j_spring_security_check'
                      method='POST'>
